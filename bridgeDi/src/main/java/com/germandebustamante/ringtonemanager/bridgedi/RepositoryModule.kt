...
import com.germandebustamante.ringtonemanager.data.repository.FavoritesRepositoryImpl
...
val repositoryModule = module {
    ...
    single { FavoritesRepositoryImpl(get(), get()) } bind FavoritesRepository::class
}
